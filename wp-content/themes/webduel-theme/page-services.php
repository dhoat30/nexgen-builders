            ...
            <?php
                    ...
                    while($query3->have_posts()){ 
                        ...
                        <div class="card box-shadow">
                            <a href="<?php echo get_the_permalink(); ?>" class="rm-dec archive-service-card">
                                ...
                                <a href="<?php echo get_the_permalink(); ?>" class="rm-dec blue light paragraph link archive-service-card"> Read More <i class="fal fa-long-arrow-right"></i></a>
                            </a>
                        </div>
                        <?php
                    }
