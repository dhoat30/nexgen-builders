...
require get_theme_file_path('/inc/gallery.php');
 ...
 function nexgen_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.64b2fa34ab0c383a5793.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.64b2fa34ab0c383a5793.css'));      
      wp_enqueue_style('our-vendor-styles', get_theme_file_uri('/bundled-assets/styles.64b2fa34ab0c383a5793.css'));
    }
