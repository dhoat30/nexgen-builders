...
require get_theme_file_path('/inc/gallery.php');
 ...
 function nexgen_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.ea3a9bc5b41a0aa42551.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.ea3a9bc5b41a0aa42551.css'));      
